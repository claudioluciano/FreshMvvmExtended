...
namespace FreshMvvmExtended
{
    public class FreshMasterDetailNavigationContainer : Xamarin.Forms.MasterDetailPage, IFreshNavigationService
    {
        ...
        public FreshMasterDetailNavigationContainer() : this(FreshConstants.DefaultNavigationServiceName)
        {
        }
        ...
        protected virtual void CreateMenuPage(string menuPageTitle, string menuIcon = null)
        {
            ...
            {
                if (_pages.ContainsKey((string)args.Item))
                {
                    Detail = _pages[(string)args.Item];
                }
